package com.xhsj.customview.textdraw.view;
...
public class SimpleColorChangeTextView extends AppCompatTextView {
    ...
    private String mText = "绘制文字";//成员变量
...
//        public float top; 从baseline到文字最顶端的尺寸
    ...
    private void drawCenterText(final Canvas canvas){
         ...
         *
         * 所以 float baseline = getHeight()/2 + (fontMetrics.descent - fontMetrics.ascent)/2 - descent
         *
        ...
        //float baseline = 0- (fontMetrics.descent + fontMetrics.ascent)/2;
